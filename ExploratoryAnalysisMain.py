...
License: GPL 3.0
Description: Phase 1 of AutoMLPipe-BC - This 'Main' script manages Phase 1 run parameters, updates the metadata file (with user specified run parameters across pipeline run)
